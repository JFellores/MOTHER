...
//#endregion
//#region node_modules/@pixi/utils/node_modules/eventemitter3/index.js
...
//#endregion
//#region node_modules/@pixi/utils/node_modules/earcut/src/earcut.js
...
function determineCrossOrigin(url$1, loc) {
	...
	if (!tempAnchor$1) tempAnchor$1 = document.createElement("a");
...
var TickerListener = function() {
	...
	*/
	TickerListener.prototype.emit = function(deltaTime) {
		if (this.fn) if (this.context) this.fn.call(this.context, deltaTime);
	...
	*/
	GeometrySystem.prototype.initGeometryVao = function(geometry, shader, incRefCount) {
		...
		for (var j in attributes) {
			...
			if (attribute.stride === void 0) if (tempStride[attribute.buffer] === attribSize * byteSizeMap[attribute.type]) attribute.stride = 0;
	...
	GeometrySystem.prototype.activateVao = function(geometry, program) {
		...
		for (var j in attributes) {
			...
			if (program.attributeData[j]) {
				...
				if (attribute.instance) if (this.hasInstance) gl.vertexAttribDivisor(location, 1);
	...
	*/
	GeometrySystem.prototype.draw = function(type, size, start, instanceCount) {
		...
		if (geometry.indexBuffer) {
			...
			if (byteSize === 2 || byteSize === 4 && this.canUseUInt32ElementIndex) if (geometry.instanced) gl.drawElementsInstanced(type, size || geometry.indexBuffer.data.length, glType, (start || 0) * byteSize, instanceCount || 1);
...
var MaskData = function() {
	...
	*/
	...
	Object.defineProperty(MaskData.prototype, "filter", {
		...
		set: function(value) {
			if (value) if (this._filters) this._filters[0] = value;
...
function generateUniformsSync(group, uniformData) {
	...
	for (var i in group.uniforms) {
		...
		if (!data) {
			if ((_a = group.uniforms[i]) === null || _a === void 0 ? void 0 : _a.group) if (group.uniforms[i].ubo) funcFragments.push("\n                        renderer.shader.syncUniformBufferGroup(uv." + i + ", '" + i + "');\n                    ");
	...
	*/
	function Shader(program, uniforms) {
		...
		*/
		...
		if (uniforms) if (uniforms instanceof UniformGroup) this.uniformGroup = uniforms;
...
var AbstractMaskSystem = function() {
	...
	*/
	AbstractMaskSystem.prototype.setMaskStack = function(maskStack) {
		...
		if (newStackLen !== curStackLen) if (newStackLen === 0) gl.disable(this.glConst);
		else {
...
var Renderer = function(_super) {
	...
	*/
	Renderer.prototype.render = function(displayObject, options) {
		...
		if (options) if (options instanceof RenderTexture) {
...
//# sourceMappingURL=@pixi_loaders.js.map